...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-10 mt-4 px-2 text-xl font-medium !leading-[1.5] sm:text-4xl"
      ...
      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-3 px-2 text-base sm:text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-6 py-3 w-full sm:w-auto flex items-center justify-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
          onClick={() => {
        ...
        <div className="flex items-center gap-3 mt-1 sm:mt-0">
          <a
            ...
            href="https://www.linkedin.com/in/sherif-abdullah-b94385236/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          ...
          <a
            ...
            href="https://github.com/sherifabdallah"
            target="_blank"
          >
            <FaGithubSquare />
          </a>
